    ...
    public partial class ExercisesViewModel
    {
        ...
        private async Task ExportExercisesAsync()
        {
            try
            {
                ...
                MessageBox.Show($"Export klaar: {count} oefening(en).", "Export", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
        ...
        private async Task ImportExercisesAsync()
        {
            try
            {
                ...
                MessageBox.Show($"Import klaar. Nieuwe items: {created}.", "Import", MessageBoxButton.OK, MessageBoxImage.Information);
